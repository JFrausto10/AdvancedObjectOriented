class KingObj {
    ...
    public KingObj(String Rank, String Color, char xLocation, int yLocation){
        this.Rank = Rank;
        this.Color = Color;
        switch (xLocation){
    ...
    private boolean kingMoveCheckHelper(int[][] chessBoard){
        if(chessBoard[this.xLocation][this.yLocation+1] == 1){
            return true;
        }
        else if(chessBoard[this.xLocation+1][this.yLocation+1] == 1){
            return true;
        }
        else if(chessBoard[this.xLocation+1][this.yLocation] == 1){
            return true;
        }
        else if(chessBoard[this.xLocation+1][this.yLocation-1] == 1){
            return true;
        }
        else if(chessBoard[this.xLocation][this.yLocation-1] == 1){
            return true;
        }
        else{
            return false;
