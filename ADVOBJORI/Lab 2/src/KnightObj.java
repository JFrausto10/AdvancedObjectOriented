class KnightObj {
    ...
    public KnightObj(String Rank, String Color, char xLocation, int yLocation){
        this.Rank = Rank;
        this.Color = Color;
        switch (xLocation){
    ...
    private boolean knightMoveCheckHelper(int[][] chessBoard){
        if(chessBoard[this.xLocation + 2][this.yLocation + 1] == 1){
            return true;
        }
        else if(chessBoard[this.xLocation + 2][this.yLocation - 1] == 1){
            return true;
        }
        else if(chessBoard[this.xLocation + 1][this.yLocation + 2] == 1){
            return true;
        }
        else if(chessBoard[this.xLocation + 1][this.yLocation - 2] == 1){
            return true;
