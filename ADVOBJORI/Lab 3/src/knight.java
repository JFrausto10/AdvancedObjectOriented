public class knight extends chessPiece{
    ...
    public knight(String Rank, String Color, char xLocation, int yLocation, String rankName){
        this.setRank(Rank);
        this.setColor(Color);
    ...
    public void isValidMove(String newPos){
        try {
            ...
            if (knightMoveCheckHelper(chessBoard)) {
    ...
    private boolean knightMoveCheckHelper(int[][] chessBoard){
        if(chessBoard[this.getXLocation() + 2][this.getYLocation() + 1] == 1){
            return true;
        }
        else if(chessBoard[this.getXLocation() + 2][this.getYLocation() - 1] == 1){
            return true;
        }
        else if(chessBoard[this.getXLocation() + 1][this.getYLocation() + 2] == 1){
            return true;
        }
        else if(chessBoard[this.getXLocation() + 1][this.getYLocation() - 2] == 1){
            return true;
